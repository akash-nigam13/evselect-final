...
const PAGES: SearchItem[] = [
  ...
  { group: "page", title: "EV Selection Tool", titleHi: "EV सिलेक्शन टूल", sub: "Find your perfect EV", subHi: "अपनी सही EV खोजें", path: "/ev-selection-tool", keywords: "ev selection tool finder choose pick select find vehicle सिलेक्शन टूल चुनें खोजें", weight: 9 },
