...
const PAGES: SearchItem[] = [
  { group: "page", title: "Compare EVs", titleHi: "EVs की तुलना करें", sub: "Side-by-side tool", subHi: "साथ-साथ टूल", path: "/compare", keywords: "compare ev tool तुलना साथ", weight: 9 },
  ...
  { group: "page", title: "Cost & range calculators", titleHi: "कॉस्ट और रेंज कैलकुलेटर", sub: "EV vs petrol, range estimator", subHi: "EV बनाम पेट्रोल, रेंज", path: "/tools", keywords: "tools cost range calculator petrol टूल कॉस्ट रेंज कैलकुलेटर", weight: 8 },
  { group: "page", title: "EV Learn hub", titleHi: "EV लर्न हब", sub: "EV basics explained", subHi: "EV की बुनियादी बातें", path: "/learn", keywords: "learn basics glossary guide लर्न सीखें", weight: 5 },
  ...
  { group: "page", title: "EV news", titleHi: "EV समाचार", sub: "Latest India EV news", subHi: "ताज़ा EV खबरें", path: "/news", keywords: "news latest समाचार खबर", weight: 5 },
