...
export const POSTS: BlogPost[] = [
  ...
  // ── Category-hub spokes (cars / scooters / bikes) ──
  {
    slug: "longest-range-electric-cars-india",
    title: "Longest-Range Electric Cars in India (2026)",
    subtitle: "The EVs that go furthest on a charge — ARAI vs real-world",
    excerpt:
      "Which electric cars have the longest range in India in 2026? Ranked by ARAI/claimed range — from mainstream long-range EVs to flagships — with real-world expectations and prices.",
    category: "Buying Guide",
    categorySlug: "buying-guide",
    readTime: "7 min",
    date: "Jun 22, 2026",
    accent: "#26E0C4",
    related: ["best-electric-cars-india-2026", "best-electric-cars-under-15-lakh-india", "real-world-range-vs-arai-india", "cost-of-owning-an-electric-car-in-india"],
  },
  {
    slug: "upcoming-electric-cars-india-2026",
    title: "Upcoming Electric Cars in India (2026): Launches to Watch",
    subtitle: "New EVs confirmed and expected through 2026",
    excerpt:
      "Which electric cars are launching in India in 2026? The confirmed and expected new EVs — from mass-market to premium — with likely price, range and timing.",
    category: "Buying Guide",
    categorySlug: "buying-guide",
    readTime: "7 min",
    date: "Jun 21, 2026",
    accent: "#26E0C4",
    related: ["best-electric-cars-india-2026", "best-electric-cars-under-15-lakh-india", "tata-sierra-ev-launch-2026", "cost-of-owning-an-electric-car-in-india"],
  },
  {
    slug: "best-electric-scooters-under-1-lakh-india",
    title: "Best Electric Scooters Under ₹1 Lakh in India (2026)",
    subtitle: "Affordable e-scooters that still go the distance",
    excerpt:
      "Looking for an electric scooter under ₹1 lakh in India? The best budget e-scooters in 2026 — compared on price, real range, top speed and everyday value.",
    category: "Buying Guide",
    categorySlug: "buying-guide",
    readTime: "7 min",
    date: "Jun 20, 2026",
    accent: "#26E0C4",
    related: ["top-5-electric-scooters-india-2026", "longest-range-electric-scooters-india", "electric-scooter-subsidy-india", "best-electric-cars-under-15-lakh-india"],
  },
  {
    slug: "longest-range-electric-scooters-india",
    title: "Longest-Range Electric Scooters in India (2026)",
    subtitle: "The e-scooters that go furthest per charge",
    excerpt:
      "Which electric scooters have the longest range in India in 2026? Ranked by ARAI/IDC range, with real-world numbers, price and who each one suits.",
    category: "Buying Guide",
    categorySlug: "buying-guide",
    readTime: "7 min",
    date: "Jun 19, 2026",
    accent: "#26E0C4",
    related: ["top-5-electric-scooters-india-2026", "best-electric-scooters-under-1-lakh-india", "electric-scooter-subsidy-india", "real-world-range-vs-arai-india"],
  },
  {
    slug: "best-electric-bikes-under-2-lakh-india",
    title: "Best Electric Bikes Under ₹2 Lakh in India (2026)",
    subtitle: "Commuter and performance e-motorcycles on a budget",
    excerpt:
      "The best electric bikes (motorcycles) under ₹2 lakh in India in 2026 — ranked on price, range, power and top speed, from value commuters to quick performers.",
    category: "Buying Guide",
    categorySlug: "buying-guide",
    readTime: "7 min",
    date: "Jun 18, 2026",
    accent: "#26E0C4",
    related: ["best-electric-motorcycles-india-2026", "fastest-electric-bikes-india", "cost-of-owning-an-electric-car-in-india", "how-to-choose-first-ev-india"],
  },
  {
    slug: "fastest-electric-bikes-india",
    title: "Fastest Electric Bikes in India (2026)",
    subtitle: "The quickest electric motorcycles you can buy",
    excerpt:
      "Which are the fastest electric bikes in India in 2026? Ranked by top speed and power — from the Ultraviolette F77 to the Ola Roadster — with range and price.",
    category: "Buying Guide",
    categorySlug: "buying-guide",
    readTime: "7 min",
    date: "Jun 17, 2026",
    accent: "#26E0C4",
    related: ["best-electric-motorcycles-india-2026", "best-electric-bikes-under-2-lakh-india", "ultraviolette-electric-bikes", "ola-electric-bikes"],
  },
