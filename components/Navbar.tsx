    ...
    mega: {
      cols: [
        ...
        },
        {
          ...
          items: [
            { label: { en: "Tata", hi: "Tata" }, href: "/brand/tata" },
            { label: { en: "Mahindra", hi: "Mahindra" }, href: "/brand/mahindra" },
            { label: { en: "MG", hi: "MG" }, href: "/brand/mg" },
            { label: { en: "Ola", hi: "Ola" }, href: "/brand/ola" },
            { label: { en: "Ather", hi: "Ather" }, href: "/brand/ather" },
            { label: { en: "Tesla", hi: "Tesla" }, href: "/brand/tesla" },
          ],
        },
        {
      ...
      cols: [
        {
          ...
          items: [
            ...
            { label: { en: "Mahindra", hi: "Mahindra" }, href: "/brand/mahindra" },
            { label: { en: "MG", hi: "MG" }, href: "/brand/mg" },
            { label: { en: "Hyundai", hi: "Hyundai" }, href: "/brand/hyundai" },
            { label: { en: "BYD", hi: "BYD" }, href: "/brand/byd" },
            { label: { en: "Kia", hi: "Kia" }, href: "/brand/kia" },
          ],
        },
        {
          ...
          items: [
            { label: { en: "Ola", hi: "Ola" }, href: "/brand/ola" },
            { label: { en: "Ather", hi: "Ather" }, href: "/brand/ather" },
            { label: { en: "TVS", hi: "TVS" }, href: "/brand/tvs" },
            { label: { en: "Bajaj", hi: "Bajaj" }, href: "/brand/bajaj" },
            { label: { en: "Revolt", hi: "Revolt" }, href: "/brand/revolt" },
            { label: { en: "Ultraviolette", hi: "Ultraviolette" }, href: "/brand/ultraviolette" },
          ],
        },
        {
          ...
          items: [
            { label: { en: "Tesla", hi: "Tesla" }, href: "/brand/tesla" },
            { label: { en: "BMW", hi: "BMW" }, href: "/brand/bmw" },
            { label: { en: "Mercedes-Benz", hi: "Mercedes-Benz" }, href: "/brand/mercedes-benz" },
            { label: { en: "Audi", hi: "Audi" }, href: "/brand/audi" },
            { label: { en: "Volvo", hi: "Volvo" }, href: "/brand/volvo" },
            { label: { en: "Citroen", hi: "Citroen" }, href: "/brand/citroen" },
          ],
        },
      ],
      promo: {
