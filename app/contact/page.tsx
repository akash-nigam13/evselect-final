...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes! We offer display advertising, sponsored articles, and category sponsorships. Email us at akash.nigam@evselect.in or select 'Advertise on EVSelect.in' in the contact form for a media kit.",
  },
  {
      ...
      <main className="pt-16 min-h-screen">
        ...
        <div className="border-b border-ev-border/30 bg-ev-surface/20 relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <Breadcrumbs items={[{ name: "Contact", path: "/contact" }]} className="mb-6" />
