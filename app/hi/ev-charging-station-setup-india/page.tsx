...
export const metadata: Metadata = {
  title: "भारत में EV चार्जिंग स्टेशन कैसे लगाएँ और बिज़नेस कैसे शुरू करें (2026) — लागत, लाइसेंस, सब्सिडी और मुनाफ़ा | EVSelect.in",
  description:
    "भारत में EV चार्जिंग स्टेशन (चार्जिंग इंफ्रास्ट्रक्चर) कैसे लगाएँ और चार्जिंग बिज़नेस कैसे शुरू करें — स्टेप-बाय-स्टेप 2026 गाइड: कोई लाइसेंस ज़रूरी नहीं, discom कनेक्शन, चार्जर टाइप (CCS2), लागत, PM E-DRIVE व राज्य सब्सिडी, और वास्तविक मुनाफ़ा/ROI।",
...
const faqs = [
  { q: "भारत में EV चार्जिंग स्टेशन कैसे लगाएँ?", a: "EV चार्जिंग स्टेशन लगाने के चरण: (1) साइट और EV मांग का आकलन करें, (2) ज़मीन/पार्किंग जगह सुनिश्चित करें, (3) चार्जर मिक्स चुनें (AC Type 2 और/या DC CCS2), (4) discom से अलग मीटर्ड EV-टैरिफ़ कनेक्शन के लिए आवेदन करें, (5) अपस्ट्रीम इलेक्ट्रिकल व सिविल इन्फ्रास्ट्रक्चर बनाएँ, (6) CEIG इलेक्ट्रिकल-सेफ़्टी और फ़ायर NOC लें, (7) नेटवर्क सॉफ़्टवेयर व पेमेंट जोड़ें, (8) नोडल एजेंसी के पास रजिस्टर करें, और (9) कमीशन कर लाइव हो जाएँ। कोई बिजली लाइसेंस ज़रूरी नहीं — पब्लिक चार्जिंग डी-लाइसेंस्ड है।" },
  { q: "भारत में EV चार्जिंग स्टेशन बिज़नेस कैसे शुरू करें?", a: "चार्जिंग बिज़नेस शुरू करने के लिए इंस्टॉल को एक कमर्शियल वेंचर की तरह देखें: ज़्यादा फुटफॉल और रुकने के समय वाली लोकेशन चुनें, खुद संचालन या किसी Charge Point Operator (CPO) के साथ साझेदारी तय करें, PM E-DRIVE व राज्य कैपिटल सब्सिडी से निवेश घटाएँ, बिजली लागत से ऊपर प्रति-kWh सर्विस चार्ज रखें, और उपयोग का ध्यान रखें (ब्रेक-ईवन के लिए आमतौर पर ~10–12% उपयोग ज़रूरी)। अच्छी साइटों पर पेबैक लगभग 18–36 महीने।" },
  { q: "इलेक्ट्रिक कारों के लिए चार्जिंग स्टेशन कैसे लगाएँ?", a: "कारों के लिए प्रमुख DC फ़ास्ट-चार्जिंग स्टैंडर्ड CCS2 (50–250 kW) है, और धीमी डेस्टिनेशन चार्जिंग के लिए Type 2 AC (7.4–22 kW)। एक पब्लिक कार-चार्जिंग पॉइंट में कम से कम 7.4 kW होना चाहिए। BIS-प्रमाणित, टाइप-टेस्टेड चार्जर चुनें, discom से समर्पित EV-टैरिफ़ कनेक्शन लें, और लाइव होने से पहले CEIG व फ़ायर NOC पूरी करें।" },
