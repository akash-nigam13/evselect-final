...
export const metadata: Metadata = {
  title: TITLE,
  description: DESC,
  alternates: altsFor("/ev-calculators/ev-emi-calculator", "hi"),
  openGraph: {
          ...
          <div className="relative mx-auto max-w-4xl px-4 pb-12 pt-12 sm:px-6 lg:px-8">
            <Breadcrumbs
              ...
              items={[
                ...
                { name: "EV EMI कैलकुलेटर", path: "/ev-calculators/ev-emi-calculator" },
              ]}
              className="mb-6"
            />
          ...
          <section className="mt-10">
            <div className="rounded-2xl border border-brand/25 bg-ev-card p-6">
              <p className="font-body text-base leading-relaxed text-ev-text/70">
                ...
                <Link
                  href={localizedHref("/ev-calculators/ev-vs-petrol-cost-calculator", "hi")}
                  className="text-brand hover:underline"
                >
