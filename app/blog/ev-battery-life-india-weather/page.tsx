            ...
            <article>
              ...
              <div className="rounded-2xl p-5 my-8 border bg-ev-green/5 border-ev-green/25">
                ...
                <p className="text-ev-text/70 font-body text-sm leading-relaxed">
                  If you implement just one recommendation from this article, make it this: <strong className="text-white">set a charge limit of 80%</strong> for everyday use. On NMC batteries, this single change can reduce calendar degradation by an estimated 25–30% over five years.
                </p>
              </div>
