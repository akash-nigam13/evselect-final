...
const post = POSTS.find((p) => p.slug === "petrol-vs-electric-5-year-cost-india")!;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.evselect.in/blog/petrol-vs-electric-5-year-cost-india" },
          ...
          <div className="grid lg:grid-cols-[1fr_280px] gap-12">
            <article>
              <p className="text-ev-text/75 font-body text-base leading-relaxed mb-4">
                The question every Indian car buyer is asking: is an electric car actually cheaper than petrol once you account for everything? The real answer lives in the total cost of ownership (TCO) — every rupee you spend from purchase day to the moment you sell the vehicle five years later, which is exactly what our guide to <Link href="/blog/cost-of-owning-an-electric-car-in-india" className="text-ev-amber hover:text-ev-cyan underline underline-offset-2">the full cost of owning an electric car in India</Link> maps out. If you are weighing your very first switch, our <Link href="/blog/how-to-choose-first-ev-india" className="text-ev-amber hover:text-ev-cyan underline underline-offset-2">guide to choosing your first EV in India</Link> walks through the decision step by step.
              </p>
              ...
              <p className="text-ev-text/75 font-body text-sm leading-relaxed mb-4">The Nexon EV Max consumes approximately <strong className="text-ev-green">17 kWh per 100 km</strong>. The Creta petrol returns roughly <strong className="text-ev-amber">14 km/litre</strong> in city conditions. The biggest swing factor here is where you charge — our <Link href="/blog/home-ev-charging-cost-india" className="text-ev-amber hover:text-ev-cyan underline underline-offset-2">home EV charging cost guide</Link> shows how cheap overnight charging widens the gap further.</p>
              <div className="overflow-x-auto rounded-2xl border border-ev-border my-6">
                <table className="w-full text-sm border-collapse">
                  <thead><tr className="border-b border-ev-border bg-ev-surface/20">
