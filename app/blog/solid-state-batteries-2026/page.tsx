...
const post = POSTS.find((p) => p.slug === "solid-state-batteries-2026")!;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.evselect.in/blog/solid-state-batteries-2026" },
          ...
          <div className="grid lg:grid-cols-[1fr_280px] gap-12">
            <article>
              <p className="text-ev-text/75 font-body text-base leading-relaxed mb-4">
                Every decade or so, a technological leap changes everything. The shift from feature phones to smartphones. From petrol to hybrid. 2026–2028 is looking increasingly like that inflection point for EV batteries. Solid-state batteries — long promised, long delayed — are now entering limited commercial production, just as India's EV market hits record volumes, as our <Link href="/blog/india-ev-sales-fy2026" className="text-ev-cyan hover:text-ev-green underline underline-offset-2">FY2026 India EV sales analysis</Link> shows.
              </p>
              ...
              <div className="rounded-2xl p-5 my-8 border" style={{ background: "#a78bfa08", borderColor: "#a78bfa30" }}>
                ...
                <p className="text-ev-text/70 font-body text-sm leading-relaxed">
                  Short answer: <strong className="text-white">no</strong> — unless your purchase is 3+ years away. Current EVs are excellent and save significant money vs petrol right now, and today's lithium-ion packs last well over a decade when cared for — see our guide to <Link href="/blog/ev-battery-life-india-weather" className="underline underline-offset-2" style={{ color: "#a78bfa" }}>making your EV battery last 10+ years in Indian weather</Link>. SSB vehicles will be premium-priced at launch (2027–2028), with mainstream pricing likely 2030–2032. Buy a good EV now; upgrade when SSB prices normalise.
                </p>
              </div>
