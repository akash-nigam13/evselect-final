...
import { ArrowLeft, Clock, Calendar, Check, ChevronRight } from "lucide-react";
...
const scooters = [
  ...
  {
    rank: 5, name: "Vida V2 Pro", brand: "Hero MotoCorp", price: "₹1.11 L",
      ...
      <main className="pt-16 min-h-screen bg-ev-bg">
        ...
        <div className="border-b border-ev-border/30 bg-ev-surface/20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
            ...
            <span className="inline-flex items-center px-3 py-1 rounded-full text-[11px] font-mono border mb-5 bg-ev-cyan/10 border-ev-cyan/30 text-ev-cyan">
              Buying Guide
            </span>
          ...
          <div className="grid lg:grid-cols-[1fr_280px] gap-12">
            <article>
              ...
              <p className="text-ev-text/75 font-body text-base leading-relaxed mb-5">
                The Indian electric scooter market has matured remarkably. In 2026, monthly EV two-wheeler registrations crossed <strong className="text-ev-cyan">1.5 lakh units</strong> for the first time, and the competition among top brands has never been fiercer. This guide cuts through the marketing noise to give you a data-driven ranking.
              </p>
              ...
              <div className="my-10 rounded-2xl border border-dashed border-ev-cyan/30 overflow-hidden" style={{ background: "radial-gradient(ellipse 60% 60% at 50% 50%, rgba(0,229,255,0.06), #050b14)" }}>
                <div className="flex flex-col items-center justify-center py-14 px-6 text-center gap-3">
                  ...
                  <p className="text-ev-text/50 text-sm font-body max-w-md leading-relaxed">
                    <strong className="text-ev-text/70">Designer brief:</strong> Horizontal grouped bar chart comparing ARAI-certified range (solid fill, cyan) and estimated real-world range (hatched, green) for all 5 scooters. X-axis: 0–250 km. Annotate ex-showroom price beside each model name.
                  </p>
                </div>
                <p className="text-center text-xs font-body text-ev-muted italic pb-4">
                  Fig 1. ARAI range vs real-world range comparison — top 5 electric scooters in India 2026.
                </p>
              </div>
                ...
                <div key={s.rank} className="bg-ev-card border border-ev-border rounded-2xl overflow-hidden my-8" style={{ borderTopColor: s.accent, borderTopWidth: 2 }}>
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                      {[
                        { label: "ARAI Range", value: s.range },
                        { label: "Top Speed",  value: s.speed },
                        { label: "Fast Charge",value: s.charge },
              ...
              <div className="rounded-2xl p-5 my-8 border bg-ev-green/5 border-ev-green/25">
                ...
                <p className="text-ev-text/70 font-body text-sm leading-relaxed">
                  Even the most expensive scooter in this list — the Bajaj Chetak at ₹1.58 L — pays back its premium over a petrol scooter within 3–4 years on running costs alone. 2026 is the most compelling year yet to switch to electric.
                </p>
              </div>
              ...
              <div className="rounded-2xl p-5 my-8 border bg-ev-cyan/5 border-ev-cyan/25">
                ...
                <p className="text-ev-text/70 font-body text-sm leading-relaxed">
                  Always check your state-level FAME III incentives before purchasing. States like Delhi, Maharashtra, and Gujarat offer additional subsidies of ₹5,000–₹30,000 on top of central incentives, which can meaningfully shift the value calculation between models.
                </p>
              </div>
              ...
              <section className="mt-16 pt-8 border-t border-ev-border/40">
                <h2 className="font-display font-bold text-white text-xl mb-5 flex items-center gap-3">
                  <span className="w-1 h-5 rounded-full bg-ev-muted inline-block" />Sources &amp; References
                </h2>
              ...
              <div className="mt-8 p-5 bg-ev-surface/40 border border-ev-border/40 rounded-2xl">
                ...
                <p className="text-xs font-body text-ev-text/50 leading-relaxed">
                  The information on EVSelect.in is for general informational purposes only. EV specifications, pricing, and availability change frequently. All prices are indicative ex-showroom figures at time of writing and may vary by state, variant, and dealership. Always verify details directly with the manufacturer or authorised dealer before purchasing. EVSelect.in is independent and not affiliated with any vehicle manufacturer.
                </p>
              </div>
            </article>
            ...
            <aside className="hidden lg:flex flex-col gap-5 sticky top-24">
              <div className="bg-ev-card border border-ev-border rounded-2xl p-5">
                <p className="text-[10px] font-mono text-ev-muted uppercase tracking-widest mb-4">On This Page</p>
                <ul className="space-y-2">
                  {scooters.map((s) => (
                    <li key={s.rank} className="flex items-center gap-2 text-xs font-body text-ev-muted hover:text-ev-cyan transition-colors cursor-pointer">
