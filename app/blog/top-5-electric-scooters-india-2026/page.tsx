          ...
          <div className="grid lg:grid-cols-[1fr_280px] gap-12">
            <article>
              <p className="text-ev-text/75 font-body text-base leading-relaxed mb-5">
                The Indian electric scooter market has matured remarkably. In 2026, monthly EV two-wheeler registrations crossed <strong className="text-ev-cyan">1.5 lakh units</strong> for the first time, and the competition among top brands has never been fiercer. This guide cuts through the marketing noise. If this is your first electric vehicle, our <Link href="/blog/how-to-choose-first-ev-india" className="text-ev-cyan hover:text-ev-green underline underline-offset-2">guide to choosing your first EV in India</Link> is a useful companion read.
              </p>
              ...
              <div className="rounded-2xl p-5 my-8 border bg-ev-cyan/5 border-ev-cyan/25">
                ...
                <p className="text-ev-text/70 font-body text-sm leading-relaxed">Always check state-level FAME III incentives before purchasing. Delhi, Maharashtra, and Gujarat offer additional subsidies of ₹5,000–₹30,000 on top of central incentives — see our <Link href="/blog/ev-subsidies-road-tax-by-state-india-2026" className="text-ev-cyan hover:text-ev-green underline underline-offset-2">state-by-state EV subsidy and road tax guide for 2026</Link> for the latest figures.</p>
              </div>
              ...
              <div className="rounded-2xl p-5 my-8 border bg-ev-green/5 border-ev-green/25">
                ...
                <p className="text-ev-text/70 font-body text-sm leading-relaxed">Even the most expensive scooter — the Bajaj Chetak at ₹1.58 L — pays back its premium over a petrol scooter within 3–4 years on running costs alone. Most of those savings come from cheap home charging — our breakdown of <Link href="/blog/home-ev-charging-cost-india" className="text-ev-cyan hover:text-ev-green underline underline-offset-2">home EV charging costs in India</Link> shows exactly how the maths works. If you have your heart set on the segment leader, you can also explore the full <Link href="/catalog/brand/ola" className="text-ev-cyan hover:text-ev-green underline underline-offset-2">Ola Electric lineup</Link>. 2026 is the most compelling year yet to switch to electric.</p>
              </div>
            ...
            <aside className="hidden lg:flex flex-col gap-5 sticky top-24">
              ...
              <div className="bg-ev-card border border-ev-cyan/20 rounded-2xl p-5">
                ...
                <Link href="/compare-electric-vehicles" className="block text-center py-2.5 rounded-xl text-xs font-display font-bold bg-ev-cyan text-ev-bg hover:bg-ev-green transition-colors">Compare EVs →</Link>
              </div>
              <div className="border border-dashed border-ev-border/40 rounded-xl h-[250px] flex items-center justify-center bg-ev-surface/20">
                <div className="text-center"><p className="text-[10px] font-mono text-ev-border uppercase tracking-widest">Advertisement</p><p className="text-[10px] font-mono text-ev-border/50 mt-1">300×250</p></div>
              </div>
