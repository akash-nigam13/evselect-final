...
const post = POSTS.find((p) => p.slug === "ev-charging-infrastructure-india")!;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.evselect.in/blog/ev-charging-infrastructure-india" },
          ...
          <div className="grid lg:grid-cols-[1fr_280px] gap-12">
            <article>
              ...
              <p className="text-ev-text/75 font-body text-base leading-relaxed mb-5">
                The nuance is that coverage is wildly uneven. The top 20 corridors are well served. The next 100 are patchy. And the 500+ routes beyond that remain genuinely challenging. This guide will tell you exactly where you stand. For the bigger picture on how fast the network is expanding, see our <Link href="/blog/india-ev-charging-network-2026" className="text-ev-cyan hover:text-ev-green underline underline-offset-2">2026 India EV charging network update</Link>.
              </p>
              ...
              <div className="rounded-2xl p-5 my-8 border bg-ev-cyan/5 border-ev-cyan/25">
                ...
                <p className="text-ev-text/70 font-body text-sm leading-relaxed">
                  If you drive primarily in metros and on the top 20 national highway corridors, charging anxiety in 2026 is largely a solved problem — especially since most owners do 80–90% of their charging cheaply at home (see our <Link href="/blog/home-ev-charging-cost-india" className="text-ev-cyan hover:text-ev-green underline underline-offset-2">home EV charging cost guide</Link>). Accurate range planning matters on longer legs, so it helps to know your car's <Link href="/blog/real-world-range-vs-arai-india" className="text-ev-cyan hover:text-ev-green underline underline-offset-2">real-world range versus its ARAI figure</Link>. If your routes take you into tier-3 cities, hill stations, or coastal stretches, plan carefully and carry a portable AC charging cable. By 2028, NHAI&apos;s mandate requiring chargers at every petrol station on national highways will have closed most remaining gaps.
                </p>
              </div>
