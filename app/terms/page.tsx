      ...
      <main className="pt-16 min-h-screen">
        ...
        <div className="border-b border-ev-border/30 bg-ev-surface/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
            <Breadcrumbs items={[{ name: "Terms of Use", path: "/terms" }]} className="mb-6" />
              ...
              <Section id="ip" title="Intellectual Property">
                <div className="bg-ev-card border border-ev-amber/20 rounded-xl p-5">
                  <P>
                    ...
                    All original material on this Site — including its source code, website design and
                    layout, written articles and guides, the organisation and presentation of its
                    specification and comparison data, tools, and other editorial content — is the
                    exclusive property of {SITE} and is protected as an original work of authorship
                    under the Copyright Act, 1957 (India) and applicable international copyright law
                    (including the Berne Convention). Copyright in this work vests in {SITE} from the
                ...
                <P>
                  No part of this Site may be copied, reproduced, republished, scraped, mirrored,
                  framed, adapted, translated, or otherwise exploited — in whole or in part, in any
                  medium — without the prior written permission of {SITE}. Unauthorised use,
                  reproduction, or distribution of our content may result in takedown action and
